    ...
    function getmediaelement() {
      ...
      <div class="media-card-text">
           ...
           <p id="likes-${title}" class="media-card-likes numberLikes" value="${likes}">${likes}</p>
            ...
            <img id="${title}" src="./assets/icons/heart-regular.svg" class="infos-Likes-Icon heart" tabindex="0" alt="likes"/>
           </div>
         </div>`;
        } else if (elementportfolio.hasOwnProperty('video')) {
            article.innerHTML = `<video tabindex="0" title="${title}" controls media-id="${id}" preload="metadata" class="media-card-img"  >
          ...
          <div class="likes-media">
           ...
           <img src="./assets/icons/heart-regular.svg" class="infos-Likes-Icon heart" tabindex="0" alt="likes"/>
          </div> 
        </div>
         `;
